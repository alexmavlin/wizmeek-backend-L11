    ...
    <section class="create_form">
        <form action="{{ route('admin_artists_store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form__row labelled row" style="padding-top: 35px">
                ...
                {{-- Spotify --}}
                <div class="form__froup">
                    <input type="text" placeholder="" name="spotify_link" id="spotify_link" value="{{ old('spotify_link') ?: '' }}">
                ...
                {{-- Apple Music --}}
                <div class="form__froup">
                    <input type="text" placeholder="" name="apple_music_link" id="apple_music_link" value="{{ old('apple_music_link') ?: '' }}">
                ...
                {{-- Instagram --}}
                <div class="form__froup">
                    <input type="text" placeholder="" name="instagram_link" id="instagram_link" value="{{ old('instagram_link') ?: '' }}">
