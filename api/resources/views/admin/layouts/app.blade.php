...
<body>
    <header class="header">
        <div class="container">
            <div class="header__inner">
                <a href="{{ route('admin_dashboard') }}" title="Wizmeek Dashboard" class="header__logo">
                    <img src="{{ asset('img/wizmeek_logo.webp') }}" alt="Wizmeek" width="150" height="27">
                </a>
            </div>
        </div>
    </header>
    @if (session('error'))
        <div class="error_alert" role="alert" id="error_alert">
            <span class="block sm:inline">{!! session('error') !!}</span>
            <div class="error_alert_countdown"></div>
        </div>
    @endif
        ...
        <aside class="content__aside">
            <nav>
                <ul>
                    ...
                    <li>
                        <a href="{{ route('admin_homepage_index') }}"
                            class="{{ Route::is('admin_homepage_index') ? 'active' : '' }}">
                            Home
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin_feedback_index') }}"
                            class="{{ Route::is('admin_feedback_index') || Route::is('admin_feedback_view') ? 'active' : '' }}">
                            Feedback
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('admin_youtube_video_index') }}"
                    ...
                    <li>
                        <a href="{{ route('admin_genres_index') }}"
                            class="{{ Route::is('admin_genres_index') ||
                            Route::is('admin_genres_create') ||
                            Route::is('admin_genres_view') ||
                            Route::is('admin_genres_edit')
                                ? 'active'
                                : '' }}">
                            Music Genre
                        </a>
                    ...
                    <li>
                        <a href="{{ route('admin_artists_index') }}"
                            class="{{ Route::is('admin_artists_index') ||
                            Route::is('admin_artists_create') ||
                            Route::is('admin_artists_view') ||
                            Route::is('admin_artists_edit')
                                ? 'active'
                                : '' }}">
                            Artists
                        </a>
    ...
    @vite(array_merge(['resources/js/admin/popup.js', 'resources/js/alerts.js'], $data['js']))
</body>
